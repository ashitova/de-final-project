...
INSERT_QUERY = "INSERT INTO {} (id, visit_date, visits, created_at, feature_version) VALUES({}, '{}', {}, now(), '{}');"
...
def form_insert_statement(ti=None, **kwargs):
    ...
    for q in query_results:
        st = INSERT_QUERY.format(CLICKHOUSE_TABLE, i, q.get('visit_date').date(), q.get('visits'), feature_version)
        i += 1
