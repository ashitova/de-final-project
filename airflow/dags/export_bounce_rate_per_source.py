...
FEATURE_NAME = "bounce_rate_per_source"
...
INSERT_QUERY = "INSERT INTO {} (id, utm_source, bounce_rate, created_at, feature_version) VALUES({}, '{}', {}, now(), '{}');"
...
def form_insert_statement(ti=None, **kwargs):
    ...
    for q in query_results:
        st = INSERT_QUERY.format(CLICKHOUSE_TABLE, i, q.get('utm_source'), int(q.get('bounce_rate')), feature_version)
        i += 1
