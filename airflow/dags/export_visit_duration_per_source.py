...
FEATURE_NAME = "visit_duration_per_source"
...
INSERT_QUERY = "INSERT INTO {} (id, utm_source, avg_visit_duration, created_at, feature_version) VALUES({}, '{}', {}, now(), '{}');"
...
def form_insert_statement(ti=None, **kwargs):
    ...
    for q in query_results:
        st = INSERT_QUERY.format(CLICKHOUSE_TABLE, i, q.get('utm_source'), q.get('avg_visit_duration'), feature_version)
        i += 1
